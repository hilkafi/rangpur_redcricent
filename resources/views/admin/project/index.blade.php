...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h3 class="col-md-10 card-title">Project List</h3>
                <a href="{{ url('controll_panel/project/create') }}" class="col-md-2 btn btn-success">Add Project</a>
            </div>
        </div>
            <!-- /.card-header -->
        <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                    ...
                    <?php $counter = 0; ?>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td style="">{{ Str::limit($data->description, 50) }}</td>
...
window.onload = function(){
    ...
    $("#search-btn").on('click', function() {
        ...
        var _url = "{{ url('/controll_panel/project/search') }}"
    ...
    $(".deleteButton").on('click', function(){
        ...
        var _url = '{{url("controll_panel/project/delete") }}';
