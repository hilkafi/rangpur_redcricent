...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h3 class="col-md-10 card-title">Executive Committee</h3>
                <a href="{{ url('controll_panel/executive-committee/create') }}" class="col-md-2 btn btn-success">Add Member</a>
            </div>
        </div>
            <!-- /.card-header -->
        <div class="card-body">
...
window.onload = function(){
    ...
    $("#search-btn").on('click', function() {
        ...
        var _url = "{{ url('/controll_panel/executive-committee/search') }}"
    ...
    $(".deleteButton").on('click', function(){
        ...
        var _url = '{{url("controll_panel/executive-committee/delete") }}';
